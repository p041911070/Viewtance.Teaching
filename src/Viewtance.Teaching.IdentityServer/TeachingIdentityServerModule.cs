...
namespace Viewtance.Teaching
{
    ...
    public class TeachingIdentityServerModule : AbpModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                Configure<AbpVirtualFileSystemOptions>(options =>
                {
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<TeachingDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}Viewtance.Teaching.Domain", Path.DirectorySeparatorChar)));
                });
            }
