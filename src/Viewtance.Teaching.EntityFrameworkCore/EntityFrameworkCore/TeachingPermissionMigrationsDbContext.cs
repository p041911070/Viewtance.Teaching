...
namespace Viewtance.Teaching.EntityFrameworkCore
{
    ...
    public class TeachingPermissionMigrationsDbContext : 
        AbpDbContext<TeachingPermissionMigrationsDbContext>
    {
        ...
        public TeachingPermissionMigrationsDbContext(DbContextOptions<TeachingPermissionMigrationsDbContext> options)
            : base(options)
        {
