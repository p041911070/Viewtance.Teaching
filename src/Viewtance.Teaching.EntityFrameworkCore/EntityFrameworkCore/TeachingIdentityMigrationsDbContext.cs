...
namespace Viewtance.Teaching.EntityFrameworkCore
{
    ...
    public class TeachingIdentityMigrationsDbContext : 
        AbpDbContext<TeachingIdentityMigrationsDbContext>
    {
        ...
        public TeachingIdentityMigrationsDbContext(DbContextOptions<TeachingIdentityMigrationsDbContext> options)
            : base(options)
        {
