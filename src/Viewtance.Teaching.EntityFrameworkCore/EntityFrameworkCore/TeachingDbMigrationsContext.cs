...
namespace Viewtance.Teaching.EntityFrameworkCore
{
    ...
    public class TeachingMigrationsDbContext : 
        AbpDbContext<TeachingMigrationsDbContext>
        ...
        //ISaasDbContext
    {
        ...
        public TeachingMigrationsDbContext(DbContextOptions<TeachingMigrationsDbContext> options)
            : base(options)
        {
