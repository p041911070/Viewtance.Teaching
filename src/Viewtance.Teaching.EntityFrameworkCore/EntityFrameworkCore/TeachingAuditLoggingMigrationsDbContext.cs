...
namespace Viewtance.Teaching.EntityFrameworkCore
{
    ...
    public class TeachingAuditLoggingMigrationsDbContext : 
        AbpDbContext<TeachingAuditLoggingMigrationsDbContext>
    {
        ...
        public TeachingAuditLoggingMigrationsDbContext(DbContextOptions<TeachingAuditLoggingMigrationsDbContext> options)
            : base(options)
        {
